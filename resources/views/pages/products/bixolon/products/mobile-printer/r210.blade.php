            ...
            <div class="body-standard">
                ...
                <section class="section-3">
                    ...
                    <ul class="accessory-list">
                        ...
                        <li>
                            <img src="/images/new-website/products/bixolon/accessories/2_USB Cable.png" alt="accessories-bixolon">
                            <h3>
                                USB Cable
                            </h3>
                            <p>
                        ...
                        <li>
                            <img src="/images/new-website/products/bixolon/accessories/3_Belt Clip.png" alt="accessories-bixolon">
                            <h3>
                                Belt Clip
                            </h3>
                            <p>
                        ...
                        <li>
                            <img src="/images/new-website/products/bixolon/accessories/4_Belt Strap.png" alt="accessories-bixolon">
                            <h3>
                                Belt Strap
                            </h3>
                            <p>
                                Looped secure belt strap for hands free convenience
                            </p>
                        </li>
                        <li>
                            <img src="/images/new-website/products/bixolon/accessories/5_Shoulder Strap.png" alt="accessories-bixolon">
                            <h3>
                                Shoulder Strap
                            </h3>
                            <p>
                                Simply carrying printer via shoulder strap
                            </p>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <p>
                                Battery pack for 3 & 4-inch Mobile Printers
                            </p>
                        </li>
                        <li>
                            ...
                            <p>
                                Single battery cradle for 3 & 4-inch mobile printers
                            </p>
                        </li>
                        <li>
                            <img src="/images/new-website/products/bixolon/accessories/8_Quad Battery Cradle.png" alt="accessories-bixolon">
                            <h3>
                                Quad Battery Cradle
                            </h3>
                            <p>
                        ...
                        <li>
                            <img src="/images/new-website/products/bixolon/accessories/11_Protective.png" alt="accessories-bixolon">
                            <h3>
                                Protective Case
                            </h3>
                            <p>
