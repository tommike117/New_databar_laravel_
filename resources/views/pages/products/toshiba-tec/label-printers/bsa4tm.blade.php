...
@section('title', 'BSA4TM | TOSHIBA-TEC | DATABAR COMPANY LIMITED')


@section('link')
<link rel="stylesheet" href="{{ URL::to('/css/new-website/products/toshiba-tec/bsa4tm/main.css')}}">
<link rel="stylesheet" href="{{ URL::to('/css/new-website/products/toshiba-tec/bsa4tm/style.css')}}">
                            ...
                            <nav aria-label="breadcrumb" id="breadcrumb">
                                <ol itemscope itemtype="http://schema.org/Product" class="breadcrumb mt-lg-5" style="background:transparent;margin-top: 60px !important; ">
                                    ...
                                    <li class="breadcrumb-item d-flex active" aria-current="page">
                                        <h1 itemprop="name" class="m-auto" style="font-size: 14px !important;">Toshiba BSA4TM</h1>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        <figure class="pic-thumbnail" style=" text-align: center; padding-left: 140px; padding-right: 40px; margin-top:50px">
                            <img id="a01" src="{{URL::asset('/images/new-website/products/toshiba-tec/label-printers/b-sa4tm-r.png')}}" style="width:100%;" alt="Matrix 120" title="Toshiba BSA4TP">
                        </figure>
                        <div class="thumbnails">
                            <ul class="ul-product">
                                <li class="li-product_color1">
                                    <img src="/images/new-website/products/toshiba-tec/label-printers/b-sa4tm-r.png" alt="Toshiba BSA4TP preview1">
                                </li>
                                <li class="li-product_color1">
            ...
            <div class="body-standard">
                <section class="section-1">
                    ...
                    <div class="w-100 d-flex">
                        ...
                        <div class="col-sm-7 col-md-7 col-lg-7 text-1">
                            <p>
                                238 mm (W) x 402 mm (D) x 332 mm (H)
                            </p>
                        </div>
                    </div>
                    <div class="w-100 d-flex">
                        ...
                        <div class="col-sm-7 col-md-7 col-lg-7 text-1">
                            <p>
                                15 kg (without media and ribbon)
                            </p>
                        </div>
                    </div>
                </section>
...
@section('script')
    <script src="{{ URL::asset('/js/page-js/toshiba-tec/bsa4tm/main.js')}}"></script>
@endsection
