...
<div class="container-fluid p-lg-5">
    <div class="row m-xs-auto">
        ...
        <div class="flex-half content">
            ...
            <h2 class="product-type">Panel Mount Keyboard with Touchpad and Backlighting</h2>
            <h3 class="description mt-3">Description</h3>
            <p class="p-description">iKey®’s SlimKey® SLP-102-TP panel mount keyboard provides full-size versatility in a rugged, compact design with the added convenience of an integrated touchpad. It features red LED backlit keys for use in areas with minimal lighting. Engineered for NEMA 4X protection against dust, water and corrosive liquids, the SlimKey® SLP-102-TP is ideal for use in environments ranging from manufacturing to material handling to medical settings. Its large numeric pad allows for easy data entry, while its robust polycarbonate case protects it against any hazardous environment.</p>
            <div class="feature">
                <h3>Features</h3>
                <ul>
