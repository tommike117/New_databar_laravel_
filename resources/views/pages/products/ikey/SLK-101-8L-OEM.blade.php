...
<div class="container-fluid p-lg-5">
    <div class="row m-xs-auto">
        ...
        <div class="flex-half content">
            ...
            <h2 class="product-type">Rugged OEM Keyboard Offers Eight Levels of Backlighting</h2>
            <h3 class="description mt-3">Description</h3>
            <p class="p-description">iKey®’s SlimKey® SLK-101-8L-OEM provides full-sized versatility in a rugged, compact design. It features eight levels of green LED backlighting, and is also available in a night vision (NVIS) compatible configuration. Engineered for NEMA 4X protection from dust, water and corrosive liquids, the SLK-101-8L is ideal for use in military applications. The large numeric pad on the SLK-101-8L allows for easy data entry, while the robust polycarbonate case stands up in the roughest of conditions. Ideal for harsh EMI environments, this rugged keyboard is designed to meet MIL-STD-461G specifications.Each kit is comprised of an industrial silicone keypad, switch matrix board, keyboard controller and cables.</p>
            <div class="feature">
                <h3>Features</h3>
                <ul>
                    <li class="feature-li mb-2">Green Backlit Keys with Eight Levels of Backlighting</li>    
                    ...
                    <li class="feature-li mb-2">Green LED</li>
                    <li class="feature-li mb-2">Silicone Rubber</li>
                    <li class="feature-li mb-2">Thin Design</li>
