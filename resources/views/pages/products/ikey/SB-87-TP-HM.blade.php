            ...
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb" style="background:transparent;">
                    ...
                    <li class="breadcrumb-item d-flex active" aria-current="page">
                        <h1 class="m-auto" style="font-size:15px;">SB-87-TP-HM</h1>
                    </li>
                </ol>
            </nav>
            <figure class="figure-image">
            <img src="{{URL::asset('images/ikey/fleet/SB-87-TP-HM.jpg')}}">
            </figure>
        </div>
        <div class="flex-half content">
            <h1 class="product-name">SB-87-TP-HM</h1>
            <h2 class="product-type">SkinnyBoard<sup>®</sup> Mobile Keyboard with Touchpad</h2>
            <h3 class="description mt-3">Description</h3>
            <p class="p-description">This is iKey’s thinnest keyboard to date, measuring only half an inch deep. Its sealed, streamlined case and silicone rubber keys meet IP65 standards, making it fully resistant to spills, cleaning procedures and the elements. Built for convenience and versatility in mobile computing applications, the SB-87-TP-HM features an integrated touchpad, eliminating the need for an external pointing device. In addition, its red LED backlighting is ideal for nighttime or ambient-light use.</p>
            <div class="feature">
                <h3>Features</h3>
                <ul>
