...
<div class="container-fluid p-lg-5">
    <div class="row m-xs-auto">
        ...
        <div class="flex-half content">
            ...
            <h2 class="product-type">17-Inch High Bright Display</h2>
            <h3 class="description mt-3">Description</h3>
            <p class="p-description">The FP17-PM-HB-1000 from iKey® is a daylight-readable flat panel display. It operates in extreme temperatures, making it ideal for use in harsh environments. This displays boasts a 1000-nit display and is NEMA 4X rated, making it resistant to dirt, debris, liquids and corrosives. In addition, the FP17-PM-HB-1000 has an LED backlight life of 70,000 hours.</p>
            <div class="feature">
                <h3>Features</h3>
                <ul>
