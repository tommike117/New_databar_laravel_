...
{{-- Title Website --}}
@section('title', 'Galaxy Tab Active Pro | Samsung Tablet | DATABAR COMPANY LIMITED')
            ...
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb mt-lg-5" style="background:transparent;">
                    ...
                    <li class="breadcrumb-item d-flex active" aria-current="page">
                        <h1 class="m-auto" style="font-size:15px;">Galaxy Tab Active Pro</h1>
                    </li>
                </ol>
            </nav>
            <img id="GTA2" src="/images/samsung/galaxy-tab-active-pro/GTApro_1.png" style="width:100%;padding:0 5% 0 20%;"
                title="Samsung Galaxy Tab Active Pro Rugged Tablet" alt="Galaxy Tab Active Pro Rugged Tablet">
            <div class="thumbnails">
                <ul class="ul-product">
                    <li class="li-product">
                        <img src="/images/samsung/galaxy-tab-active-pro/GTApro_1.png" alt="Galaxy Tab Active Pro Rugged Tablet preview-1" title="Samsung Galaxy Tab Active Pro Rugged Tablet preview-1">
                    </li>
                    <li class="li-product">
                        <img src="/images/samsung/galaxy-tab-active-pro/GTApro_2.png" alt="Galaxy Tab Active Pro Rugged Tablet preview-2" title="Samsung Galaxy Tab  Active Pro Rugged Tablet preview-2">
                    </li>
                    <li class="li-product">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-lg-2"
                    ...
                    <h1 class="product_name">Galaxy Tab Active Pro</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12" style="padding:30px !important;border-bottom:1px solid">
                    ...
                    <ul>
                        <li>
                            <label style="font-size:13px;" for="">Size : 10.1" (255.4mm) </label>
                        </li>
                        <li>
                            <label style="font-size:13px;" for="">Rugged and durable design</label>
                        </li>
                        <li>
                            <label style="font-size:13px;" for="">Rear Camera : 13.0 MP </label>
                        </li>
                        <li>
                            <label style="font-size:13px;" for="">Front Camera : 8.0 MP </label>
                        </li>
                        <li>
...
<script src="{{URL::asset('/js/page-js/samsung/galaxy-tab-active-pro/main.js')}}"></script>
