...
{{-- Title Website --}}
@section('title','Automation | Datalogic | DATABAR COMPANY LIMITED')

{{-- Link CSS --}}
@section('link')

<link rel="stylesheet" href="{{URL::asset('/css/new-website/products/datalogic/automation.css')}}">
@endsection
...
<div class="bg-section-1">
    <section class="section-1">
        ...
        <figure class="pic-sec-1">
            <img src="/images/new-website/products/datalogic/banner-3.jpg" alt="Banner" width="100%">
        </figure>
        <div class="text-product ">
            <a class="hover-sec-2" href="/products/datalogic/barcode-scanners">Barcode Scanners</a>
            <a class="hover-sec-1" href="/products/datalogic/mobile-computers">Mobile Computers</a>
            <a style="font-weight: 600">Automation</a>
        </div>
    ...
    <section class="section-3">
       ...
       <a href="#" style="font-weight: 600;">Automation</a>
    </section>
</div>
