...
<link rel="stylesheet" href="/css/new-website/nav-left/style_d.css">
<link rel="stylesheet" href="/css/new-website/nav-left/style_t.css">
<link rel="stylesheet" href="/css/new-website/nav-left/style_m.css">
 ...
 <!-- Modal -->
<div class="modal fade" id="myline-popup-nav" role="dialog">
...
<script>
    ...
    document.getElementById("pathname").innerHTML = res[1].charAt(0).toUpperCase() + res[1].slice(1);
