...
<link rel="stylesheet" href="/css/new-website/nav-top-products/style_d.css">
<link rel="stylesheet" href="/css/new-website/nav-top-products/style_t.css">
<link rel="stylesheet" href="/css/new-website/nav-top-products/style_m.css">
<link rel="stylesheet" href="<?= url('/css/navbar.css')?>?ver=1.0.0">


<div class="nav-desktop nav-top">
    ...
    {{-- <div  id="navbar-black" class="col-3" style="position: absolute">
        <figure class="img-databar-d" style="margin: -5px 0px 0px;">
...
<div style="position: sticky;top:0;z-index:99999">
    <a href="/home">
        ...
        {{-- <div id="nav-white-mobile" class="col-3">
            <figure class="img-databar-m" style="margin: -5px 0px 0px; postition">
        ...
        {{-- <div id="nav-white-tablet" class="col-3">
            <figure class="img-databar-t" style="margin: -5px 0px 0px;">
