...
<link rel="stylesheet" href="/css/new-website/nav-top-all-products/nav-top-products-white-then-black/style_d.css">
<link rel="stylesheet" href="/css/new-website/nav-top-all-products/nav-top-products-white-then-black/style_t.css">
<link rel="stylesheet" href="/css/new-website/nav-top-all-products/nav-top-products-white-then-black/style_m.css">
...
<div class="nav-desktop nav-top2" id="navbar2">
    ...
    <div id="navbar-white" class="col-3">
        <figure class="img-databar-d" style="margin: -5px 0px 0px;">
            <a href="/home">
                <img class="databar-logo {{ isset($databar_logo_extra_class) }}" src="/images/new-website/icon_logo_-01.png" alt="logo DATABAR">
            </a>
        </figure>
    </div>
    ...
    <div class="col-9">
        <ul id="menu" style="display: flex;">
            ...
            <li class="ml-mr-4 nav logo">
                <a style="color: white" id="products" href="/products">Products & Solutions</a>
            </li>
            <li class="ml-mr-4 nav logo">
                <a style="color: white" id="about-us" href="/about-us">About us</a>
            </li>
            <li class="ml-mr-4 nav logo">
                <a style="color: white" id="brands" href="/brands">Brands</a>
            </li>
            <li class="ml-mr-4 nav logo">
                <a style="color: white" id="services" href="/services">Services</a>
            </li>
            <li class="ml-mr-4 nav logo">
                <a style="color: white" id="customers" href="/customers">Customers</a>
            </li>
            <li class="ml-mr-4 nav logo">
