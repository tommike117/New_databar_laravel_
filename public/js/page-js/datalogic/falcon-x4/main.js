$(function(){
    ...
    $($('.li-product_color1')[0]).on('click',()=>{
        $("#a01").removeAttr('src').attr('src','/images/new-website/products/datalogic/mobile-computer/FalconX4_882x882.png')
    });
    $($('.li-product_color1')[1]).on('click',()=>{
        $("#a01").removeAttr('src').attr('src','/images/new-website/products/datalogic/mobile-computer/PLA-FALCONX4-WAREHOUSE6.jpg')
    });
    $($('.li-product_color1')[2]).on('click',()=>{
        $("#a01").removeAttr('src').attr('src','/images/new-website/products/datalogic/mobile-computer/Falcon X4_3.jpg')
    });
    $($('.li-product_color1')[3]).on('click',()=>{
        $("#a01").removeAttr('src').attr('src','/images/new-website/products/datalogic/mobile-computer/Falcon X4_5.jpg')
    });
