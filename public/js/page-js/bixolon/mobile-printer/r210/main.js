$(function(){
    ...
    $($('.li-product_color1')[0]).on('click',()=>{
        $("#a01").removeAttr('src').attr('src','/images/new-website/products/bixolon/products/mobile-printer/1562839450690080.png')
    });
    $($('.li-product_color1')[1]).on('click',()=>{
        $("#a01").removeAttr('src').attr('src','/images/new-website/products/bixolon/products/mobile-printer/SPP-R210.png')
    });
    $($('.li-product_color1')[2]).on('click',()=>{
        $("#a01").removeAttr('src').attr('src','/images/new-website/products/bixolon/products/mobile-printer/SPP-R210_2.png')
    });
    $($('.li-product_color1')[3]).on('click',()=>{
        $("#a01").removeAttr('src').attr('src','/images/new-website/products/bixolon/products/mobile-printer/SPP-R210_3.png')
    });
