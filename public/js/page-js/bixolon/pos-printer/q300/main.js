$(function(){
    ...
    $($('.li-product_color1')[0]).on('click',()=>{
        $("#a01").removeAttr('src').attr('src','/images/new-website/products/bixolon/products/pos/SRP-Q300 Series_1.png')
    });
    $($('.li-product_color1')[1]).on('click',()=>{
        $("#a01").removeAttr('src').attr('src','/images/new-website/products/bixolon/products/pos/SRP-Q300 Series_2.png')
    });
    $($('.li-product_color1')[2]).on('click',()=>{
        $("#a01").removeAttr('src').attr('src','/images/new-website/products/bixolon/products/pos/SRP-Q300 Series_3.png')
    });
