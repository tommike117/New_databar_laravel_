$(function(){
    ...
    $($('.li-product_color1')[0]).on('click',()=>{
        $("#a01").removeAttr('src').attr('src','/images/new-website/products/caterpillar/products/t20/T20-0.png')
    });
    $($('.li-product_color1')[1]).on('click',()=>{
        $("#a01").removeAttr('src').attr('src','/images/new-website/products/caterpillar/products/t20/T20-1.png')
    });
    $($('.li-product_color1')[2]).on('click',()=>{
        $("#a01").removeAttr('src').attr('src','/images/new-website/products/caterpillar/products/t20/T20-2.png')
    });
    $($('.li-product_color1')[3]).on('click',()=>{
        $("#a01").removeAttr('src').attr('src','/images/new-website/products/caterpillar/products/t20/T20-3.png')
    });
